...
and increases monotonically with crack density, approaching the
standard stick percolation threshold only asymptotically.
The conducting substrate always provides partial benefit:
$\eta_c^\mathrm{Voronoi}$ remains below the standard value
even at high crack densities.
